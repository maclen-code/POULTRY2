package com.example.poultry2.ui.dashboard.cluster.clusterDashboard.clusterDsp.clusterDspDashboard
...
import com.example.poultry2.ui.dashboard.cluster.clusterDashboard.clusterDsp.clusterDspDashboard.clusterDspCategory.DashClusterDspCategoryFragment
import com.example.poultry2.ui.dashboard.cluster.clusterDashboard.clusterDsp.clusterDspDashboard.clusterDspChannel.DashClusterDspChannelFragment
...
class ClusterDspDashboardActivity : AppCompatActivity()  {
    ...
    private fun setupMenu() {
        (this).addMenuProvider(object : MenuProvider {
            ...
            override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
                ...
                Theme.setMenuTextColor(this@ClusterDspDashboardActivity,menu)
            }
            ...
            override fun onMenuItemSelected(menuItem: MenuItem): Boolean {
                ...
                return when (menuItem.itemId) {
                    R.id.menu_filter -> {
                        ...
                        val intent = Intent(this@ClusterDspDashboardActivity,
    ...
    private fun setTabs(){
        val tabHeader= arrayOf("channel","category","customer","account","ar")
        tabHeader.forEach {
    ...
    private fun showFragment() {
        ...
        if (fragment==null) {
            when (name) {
                "channel" -> fragment = DashClusterDspChannelFragment()
                "category" -> fragment = DashClusterDspCategoryFragment()
