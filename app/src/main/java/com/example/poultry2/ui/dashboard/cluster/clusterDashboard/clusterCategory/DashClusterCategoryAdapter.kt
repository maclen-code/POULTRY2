...
class DashClusterCategoryAdapter internal constructor()
    : RecyclerView.Adapter<DashClusterCategoryAdapter.ViewHolder>() {
    ...
    private fun table1( table: TableLayout, list:List<Data.SovCategoryDsp>){
        ...
        list.groupBy { it.tradeCode }
            .map {item ->
                ...
                table1SubTotal(table,t.tradeCode, list.filter { it.tradeCode==t.tradeCode})
                list.filter { it.tradeCode==t.tradeCode}
...
//                        textColor=ContextCompat.getColor(context, R.color.textWarning)
    ...
    private fun table1SubTotal( table: TableLayout,label:String, list:List<Data.SovCategoryDsp>){
        val context=table.context
        ...
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence): FilterResults {
                ...
                if (charString.isEmpty()) {
                    ...
                    this@DashClusterCategoryAdapter.filteredList = filteredList
                }
