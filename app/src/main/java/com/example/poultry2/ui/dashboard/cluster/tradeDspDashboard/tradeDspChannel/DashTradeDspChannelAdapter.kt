...
class DashTradeDspChannelAdapter internal constructor()
    : RecyclerView.Adapter<DashTradeDspChannelAdapter.ViewHolder>() {

    private var data = emptyList<Data.SovDashTradeDspChannel>() // Cached copy of words

    var onItemClick: ((Data.SovDashTradeDspChannel)->Unit) ?= null
