package com.example.poultry2.ui.login
...
import com.example.poultry2.databinding.ActivityLoginBinding
import com.example.poultry2.ui.MainActivity
import com.example.poultry2.ui.function.MySharedPrep
import com.example.poultry2.ui.server.ServerEntryActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (pin=="") {
            val intent = Intent(this@LoginActivity, com.example.poultry2.ui.MainActivity::class.java)
